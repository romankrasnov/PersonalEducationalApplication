...
public class CreateTestFragment extends Fragment implements View.OnTouchListener

    {  //for swipe impl + MUST IMPLEMENT ICreateTestFragment!!! methods to subscribe
